            ...
            <div className="bg-secondary rounded-2xl shadow-xl p-8">
              ...
              <div className="grid md:grid-cols-5 gap-3 text-center" /* Team members grid */>
                ...
                <div>
                  ...
                  <p className="text-primary text-sm"> مطور البرمجة الامامية (FrontEnd) وتصميم الشكل العام للموقع </p>
              ...
              {/* الدكتور حسن الهذلي */}
              <br></br>
              <p className="text-2xl font-bold text-primary mb-6 text-center">شكر خاص للدكتور حسن الهذلي</p>
              <a
                    href="https://www.linkedin.com/in/hassan-alhuzali-a33888267/"  /* LinkedIn account link */
                  >
                    <img
                      src="/images/linkedin_icon.png"   /* The LinkedIn logo image is taken from a file images */
                      alt="LinkedIn"
              ...
              <p className="text-primary text-lg leading-relaxed text-center">
                نقدم شكرنا للدكتور حسن على طرح فكرة المشروع وإعطائنا فرصة لتطبيق ما تعلمناه.<br></br> دعمه كان سببا في ظهور هذا العمل.
              </p>
            </div>
