...
function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-cream dark:bg-coffee-dark font-arabic relative overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-sand/30 dark:bg-clay/55 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 -z-10 transition-colors duration-300" />
