        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex justify-between items-center gap-4">
            <button
              ...
              className="px-6 py-3 bg-stone-600 text-primary font-bold rounded-lg hover:bg-stone-900 hover:text-primary hover:scale-105 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              السابق →
            </button>
            ...
            {isLastQuestion ? (
              <button
                ...
                className="px-8 py-3 bg-secondary text-primary font-bold rounded-lg hover:bg-green-700 hover:text-primary transition-all duration-300 hover:scale-105 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
              >
              ...
              <button
                onClick={handleNext}
                disabled={!hasAnswer}
                className="px-8 py-3 bg-secondary text-primary font-bold rounded-lg hover:bg-glow hover:text-primary transition-all duration-300 hover:scale-105 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
              >
                التالي ←
              </button>
            )}
