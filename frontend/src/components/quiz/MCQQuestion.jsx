          ...
          return (
            <button
              ...
              className={`w-full p-5 text-right rounded-xl border-2 transition-all duration-300 transform hover:scale-102 ${
                isSelected
                  ? 'bg-secondary text-primary text-3xl border-secondary shadow-lg scale-102'  /*When MCQ option NOT clicked*/
                  : 'bg-white text-light border-accent hover:border-secondary hover:shadow-md' /*When clicked MCQ option*/
              }`}
            >
